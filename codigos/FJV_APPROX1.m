...
[pinterp_new]=pressureinterp(xper1,nflag,w,s,auxflag,metodoP,parameter,weightDMP);
...
% Interpolação das pressões na arestas (faces)
[pinterp_new]=pressureinterp(xper,nflag,w,s,auxflag,metodoP,parameter,weightDMP);
