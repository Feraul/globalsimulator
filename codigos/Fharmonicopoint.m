function [y]=Fharmonicopoint(kmap,N)
...
for ifacont=1:size(bedge,1)
    % calcula o ponto medio da face de contorno
...
for iface=1:size(inedge,1)
    ...
    % recalcula dos pontos que saim fora da face interna
    if strcmp(numcase,'benchmar5_6') || strcmp(numcase,'benchmar5_7')
    ...
    elseif strcmp(numcase,'edqueiroz')
